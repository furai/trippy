    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TripID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Beginning = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Destination = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StartDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime(6)", nullable: false, computedColumnSql: "DATE_ADD(StartDate, INTERVAL DurationInMinutes MINUTE)", stored: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JoinedTripsTripID = table.Column<int>(type: "int", nullable: false),
                    PassengersId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripTrippyUser", x => new { x.JoinedTripsTripID, x.PassengersId });
                    table.ForeignKey(
                        name: "FK_TripTrippyUser_AspNetUsers_PassengersId",
                        column: x => x.PassengersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripTrippyUser_Trip_JoinedTripsTripID",
                        column: x => x.JoinedTripsTripID,
                        principalTable: "Trip",
                        principalColumn: "TripID",
                        onDelete: ReferentialAction.Cascade);
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripTrippyUser_PassengersId",
                table: "TripTrippyUser",
                column: "PassengersId");
        }
